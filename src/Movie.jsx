...
function Movie() {
    ...
    const ApiUrl = "https://apdflix-0627-default-rtdb.firebaseio.com/apdMovies/" + movieName + ".json";
                            ...
                            <div className="card-body">
                                ...
                                <div className="rating-container">
                                    ...
                                    <ReactStars
                                        ...
                                        size={30}
                                     />
                                    <h2>Did Ana sleep?...  {serie.anaSleep ? <b style={{ "color": "green" }}>Yes</b> : <b style={{ "color": "red" }}>Nope</b>}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
